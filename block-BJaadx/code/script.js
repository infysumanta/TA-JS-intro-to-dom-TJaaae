...
document.querySelector("ul.topics > li:first-child").innerText =
  "all about document";
...
document.querySelectorAll("ul.topics > li").length;

// 4. Select the first input using the `type` selector and store them in variable named `emailInput`
const emailInput = document.querySelector("input[type='email']");

// 5. Select the ul element using class selector and store in `topics`
const topics = document.querySelectorAll("ul.topics");

// 6. Select the first label element and store in `label`
const = document.querySelector("label")[0];

// 7. Select the input of type `checkbox` with the `id` selector and store in `inputCheckbox`
document.querySelector("#inputCheckbox");
